...
public class Utils {
    ...
    public static List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.drawable.timeline_icon_like, R.drawable.timeline_icon_unlike, IconType.Heart));
        icons.add(new Icon(R.drawable.timeline_icon_favorite, R.drawable.timeline_icon_unfavorite, IconType.Star));
