...
public class FollowsActivity extends BaseActivity implements FollowsContract.IFollowsView, View.OnClickListener {


    private String screenName = null;
    private int cursor = 0;
    private FollowsPresenter presenter;
...
//            isFriends = intent.getBooleanExtra("friends",true);
        ...
        presenter = new FollowsPresenter(this);
...
//                presenter.getFollowsData(screenName,bean.getNext_cursor());
//            }
//            friendsBean = bean;
        }
    }
